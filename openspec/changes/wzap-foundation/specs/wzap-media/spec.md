...
Armazenar temporariamente e servir mídias recebidas e enviadas com integridade,
...
Mensagens com mídia SHALL ter o conteúdo baixado automaticamente até o limite
configurado; acima do limite, o evento MUST indicar omissão da mídia sem
interromper o fluxo.
...
A mídia armazenada MUST registrar tipo, tamanho, nome quando houver e checksum,
permitindo verificar integridade.
...
O acesso à mídia SHALL exigir autenticação de serviço; mídia inexistente ou
expirada MUST responder `404`; a resposta MUST informar o tipo de conteúdo
correto.
...
Mídias MUST expirar após o período configurado, e arquivos e registros expirados
SHALL ser removidos periodicamente.
...
Mídias enviadas por upload MUST ser validadas quanto a tipo permitido e tamanho
antes do enfileiramento; inválidas MUST responder `422`.
...
Identificadores de mídia MUST ser opacos e não sequenciais, dificultando acesso
não autorizado.
